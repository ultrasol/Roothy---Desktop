...
public class Distributor extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mdrawertoggle = new ActionBarDrawerToggle(this, drawerlayout, R.drawable.ic_drawer, R.string.app_name, R.string.app_name)//menü acýlýp kapandýðýnda action bar title deðiþimi
		{
			@Override
		...
		try
		{//menu tusuyla overflow baglamak için
		...
		// MenuItem item =optionmenu.findItem(R.id.actionlocation);
		// item.setVisible(false);
		/*
		Display display = ((WindowManager) getSystemService(WINDOW_SERVICE)).getDefaultDisplay();
		Toast.makeText(this,display.getWidth()+"x"+display.getHeight(), Toast.LENGTH_LONG).show();
		 //Not yatay ve dikey oranlarında sayısal değerler değişmektedir.
		 */
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		 ...
		 * MenuInflater menuinflater=getMenuInflater();//inflater herhangi bir view ýn java objesine dönüþtürülüp düzenlenmesinde yardýmcý olur.Burda menü düzenlenmesi için kullanacaðýz
		 * menuinflater.inflate(R.menu.menu, menu);//XML menu atanýr
		 * return super.onCreateOptionsMenu(menu);
		 */
	}
	@Override
	public boolean onOptionsItemSelected(MenuItem item)// actionbar item secildiginde
	{
		...
		{
			case R.id.send:
				new SetPayments(Distributor.this).execute(getString(R.string.setbillsurljson));
				gpsLocation.showCurrentLocation();
				break;
			case R.id.logisticdetails:
				startActivity(new Intent(Distributor.this, LogisticDetails.class).setPackage("com.google.android.apps.maps"));
				break;
			...
			case R.id.exit:
				AlertDialog.Builder alertdialogbuilder=new AlertDialog.Builder(Distributor.this);
				...
				alertdialogbuilder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener()
				{
					...
					public void onClick(DialogInterface dialog, int which)
					{
						...
						startActivity(new Intent(Distributor.this, Login.class));
						finish();
					}
				});
	...
	{
		startActivity(new Intent(Distributor.this, SalesDetails.class).putExtra("FISNO", FISNO));
	}
}
